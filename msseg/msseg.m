...
%   hs - spatial bandwidth for mean shift analysis
...
function [S L seg seg_vals seg_lab_vals seg_edges d_edges ] = msseg(img,lab_vals,hs,hr,M,full)
  gray = 0;
  if(size(img,3)==1)
    gray = 1;
    I = repmat(img,[1 1 3]);
